...
1. **Read the methodology** → `get_wstg_test("WSTG-CLNT-12")` for baseline technique guidance
2. **Check related prompt** → read `prompts/client-side.md, configuration.md` for Swarm-specific workflow
