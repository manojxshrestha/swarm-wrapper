...
#
# Usage:
#   scripts/tools/wordlist_engine.sh <target>
#   scripts/tools/wordlist_engine.sh <target> --depth 3 --mode aggressive
#   scripts/tools/wordlist_engine.sh <target> --filter loose   # keep noisy raw tokens
#
# Modes (rule set):
