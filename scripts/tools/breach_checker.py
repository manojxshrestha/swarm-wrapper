...
Usage:
  scripts/tools/breach_checker.py <wordlist.txt>
  scripts/tools/breach_checker.py <wordlist.txt> -o ranked.txt --with-counts
  scripts/tools/breach_checker.py <wordlist.txt> --min-count 1 --max-count 1000000
  scripts/tools/breach_checker.py <wordlist.txt> --limit 5000   # test/preview
"""
...
def main() -> int:
    ...
    print("[*] Querying HaveIBeenPwned (k-anonymity, no full passwords sent)...")
