...
def _clean_external_sig(sig: dict) -> dict | None:
    ...
    _WAF_STOPWORDS: set[str] = {
        "blocked", "block", "blocker", "blockpage", "page", "pages",
        "server", "servers", "detected", "detect", "syntax", "error",
        "errors", "err", "body", "bodies", "contains", "content",
        "contents", "headers", "header", "contain", "containing",
        "true", "false", "reference", "references", "number", "numbers",
        "numeric", "num", "request", "requests", "response", "responses",
        "access", "denied", "found", "find", "sorry", "but", "the", "you",
        "are", "for", "cannot", "have", "been", "because",
        "url", "uri", "urls", "powered", "intercepted", "intercept",
        "branding", "followed", "following",
        "red", "letters", "green", "channel", "channels",
        "png", "jpg", "gif", "svg", "com", "www", "http", "https",
        "code", "codes", "message", "messages", "text", "texts",
        "data", "id", "ids", "ip", "ips", "name", "names",
        "type", "types", "key", "keys",
        "time", "times", "date", "dates", "value", "values",
        "size", "sizes", "info", "information",
        "waf", "firewall", "web",
    }
