...
WebSocket vulnerabilities (especially CSWSH) require a real browser to validate because the WebSocket handshake must include the victim's cookies automatically. Use the headed browser:
