...
Use the headed browser to automate DOM vulnerability validation that requires multi-tab interaction, CSS exfiltration testing, and DOM clobbering verification.

### PostMessage Multi-Tab Validation

The headed browser opens both the target page and an attacker-controlled iframe to test postMessage origin checking:
