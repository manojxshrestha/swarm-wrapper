...
MFA/2FA flows are inherently browser-based with redirect chains, cookie management, and JavaScript-rendered challenges. Use the headed browser:
...
3. **Always use headed browser for MFA bypass validation** — MFA flows involve complex redirect chains, cookie state, and JavaScript challenges that server-side testing alone cannot fully validate.
