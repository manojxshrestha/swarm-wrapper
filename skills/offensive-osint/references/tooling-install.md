...
# Run: "$HOME/.local/bin/cloud_enum/venv/bin/python3" "$HOME/.local/bin/cloud_enum/cloud_enum.py" -k <keyword> -t 20 -qs

# Scopify (domain scope analysis)
git clone https://github.com/Arcanum-Sec/Scopify && cd Scopify && pip install -r requirements.txt
# Run: "$HOME/.local/bin/Scopify/venv/bin/python3" "$HOME/.local/bin/Scopify/scopify.py" -c "Company Name"

# Spoofy (SPF/DMARC spoof check)
git clone https://github.com/MattKeeley/Spoofy && cd Spoofy && pip install -r requirements.txt
# Run: "$HOME/.local/bin/Spoofy/venv/bin/python3" "$HOME/.local/bin/Spoofy/spoofy.py" -d <domain>
...
git clone https://github.com/manojxshrestha/Gf-Patterns /tmp/Gf-Patterns
mkdir -p ~/.gf
